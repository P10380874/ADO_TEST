...
public partial class WKF_OptionalFields_UserUpTwoLevelUC : WKF_FormManagement_VersionFieldUserControl_VersionFieldUC
{
    ...
    public override string ConditionValue
    {
        get
        {
            ...
            else
            {
                ...
                string Message_result =resultD.Rows[0].Field<string>("部門");
    ...
    public override string Message
    {
        get
        {
            ...
            else
            {
                string uid = HiddenField1.Value;
                DataTable resultD = utduco.Select_UserToDepartment_D(uid);
                string Message_result = "申請者上二層單位：" + resultD.Rows[0].Field<string>("部門");
                result = Message_result;
            }
            return result;
        }
