<%@ Control Language="C#" AutoEventWireup="true" CodeFile="UC_FLOWA.ascx.cs" Inherits="WKF_OptionalFields_CDS_PIC_WKFFields_UC_FLOWA" %>
                    ...
                    <asp:GridView runat="server" ID="gvForms" CssClass="tsGridView2 horzFull" AutoGenerateColumns="false" ShowHeader="true" ShowHeaderWhenEmpty="true"
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="表單編號" ItemStyle-Width="15%" ItemStyle-Wrap="true">
                                <ItemTemplate>
                                    <asp:LinkButton ID="lbtnFLOWB_NO" runat="server" Width="120px" Text='<%#Bind("FLOWB_NO")%>'></asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="表單狀態" ItemStyle-Width="25%" ItemStyle-Wrap="true">
                                <ItemTemplate>
                                    <!-- 協辦單簽核狀況，簽核中/結案核准/結案否決 -->
                                    <asp:Label ID="lblFLOWB_STATUS" runat="server" Width="80px" Text='<%#Bind("FLOWB_STATUS")%>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    </asp:GridView>
