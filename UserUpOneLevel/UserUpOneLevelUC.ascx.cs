...
public partial class WKF_OptionalFields_UserUpOneLevelUC : WKF_FormManagement_VersionFieldUserControl_VersionFieldUC
{
    ...
    public override string ConditionValue
    {
        get
        {
            ...
            else
            {
                ...
                string Message_result = resultT.Rows[0].Field<string>("團隊");
    ...
    public override string Message
    {
        get
        {
            ...
            else
            {
                string uid = HiddenField1.Value;
                DataTable resultT = utduco.Select_UserToDepartment_T(uid);
                string Message_result = "申請者上一層單位：" + resultT.Rows[0].Field<string>("團隊");
                result = Message_result;
            }
            return result;
        }
